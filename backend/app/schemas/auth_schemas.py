...
class RegisterRequest(BaseModel):
    ...
    student_id_number: Optional[str] = Field(None, description="Student ID (required for STUDENT role)")
    ...
    organization_id: Optional[int] = Field(None, description="Organization ID (required for SOCIO role)")
...
class CheckInRequest(BaseModel):
    ...
    model_config = {
        "json_schema_extra": {
            "example": {
                "qr_token": "1|5|1705315200|a1b2c3d4e5f6..."
            }
        }
    }
